		...
		<div className="pro-dashboard p-4 md:p-6">
			...
			<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4 md:mb-2">
				...
				<div className="flex items-center gap-2 order-1 md:order-2 w-full md:w-auto">
					...
					<div className="flex items-center gap-2 md:hidden">
						...
						{!isReadOnly && items.length > 0 && (
							<button
								className="px-2.5 py-2 border border-(--primary) text-(--primary) hover:bg-(--primary) hover:text-white transition-colors flex items-center gap-2 text-sm whitespace-nowrap"
				...
				<div className="flex items-center gap-2 order-3">
					...
					{!isReadOnly && items.length > 0 && (
						<button
							className="px-4 py-2 border border-(--primary) text-(--primary) hover:bg-(--primary) hover:text-white transition-colors items-center gap-2 text-base whitespace-nowrap hidden md:flex"
							onClick={() => setShowIterateDashboardModal(true)}
							title="Edit with LlamaAI"
						>
							<Icon name="sparkles" height={16} width={16} />
